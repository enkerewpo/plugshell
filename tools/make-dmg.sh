...
tell application "Finder"
    tell disk "$APP_NAME"
        ...
        set the bounds of container window to {170, 110, 870, 624}
        ...
        set position of item "$APP_NAME.app" of container window to {185, 202}
        set position of item "Applications" of container window to {505, 202}
        set position of item "INSTALL.txt" of container window to {612, 404}
